<template>
    <div @click="handleClick" :class="class">
        <svg v-if="alertName == 'vientosIcon'" id="vientosIcon" xmlns="http://www.w3.org/2000/svg" height="24"
        ...
        <svg v-else-if="alertName == 'agradableIcon'" id="agradableIcon" xmlns="http://www.w3.org/2000/svg" height="24"
            viewBox="0 0 24 24" width="24">
            <path d="M0 0h24v24H0z" fill="none" />
            <path
