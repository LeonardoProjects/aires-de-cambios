...
<template>
    ...
    <div
        class="min-vh-100 d-flex justify-content-center align-items-center main"
    >
        <div class="card p-4 authCard">
            ...
            <form @submit.prevent="submit">
                <div class="mb-3">
                    <label for="name" class="form-label labelCeleste"
                        >Nombre</label
                    >
                    <input
                        id="name"
                ...
                <div class="mb-3">
                    <label for="email" class="form-label labelCeleste"
                ...
                <div class="mb-3">
                    <label for="password" class="form-label labelCeleste"
                        >Contraseña</label
                    >
                    <input
                        id="password"
                ...
                >
                    <Link
                        :href="route('login')"
                        class="nav-link labelCeleste anchor"
                    >
                        ¿Ya tiene cuenta?
                    </Link>
                    ...
                    <button
                        type="submit"
                        class="btn btn-primary mt-2 btnPrimary"
